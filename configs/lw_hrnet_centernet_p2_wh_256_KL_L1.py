...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=r"F:\ITD\tools\work_dirs\lw_hrnet_centernet_p2_wh_256_KL_SmoothL1\20250625_121135\epoch_140.pth"),
)
...
visualizer = dict(
    ...
    name='visualizer',
    line_width=0.8,  # 将边界框线条宽度设置为 1 像素
    font_size=7,
    # score_thr=0.6,
    # alpha=0.4,
)
