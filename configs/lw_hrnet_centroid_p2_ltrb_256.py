...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_ltrb=dict(type='SmoothL1Loss', loss_weight=1.0),
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=r"F:\ITD\tools\work_dirs\lw_hrnet_centroid_p2_ltrb_256\20250628_132005\best_coco_bbox_mAP_epoch_40.pth"
    ),
)
...
param_scheduler = [
    ...
    dict(
        ...
        by_epoch=True,
        milestones=[30, 60],  # 在第90和120个epoch降低学习率
        gamma=0.1)
]
