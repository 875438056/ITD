...
custom_imports = dict(
    imports=['models.backbones.lightweight_hrnet_p2',
             ...
             'models.heads.centroid_heatmap_head',
...
litehrnet_extra = dict(
    ...
    with_head=False  # 在 MMDetection 中作为 backbone 使用时，必须为 False
)
...
param_scheduler = [
    ...
    dict(
        ...
        by_epoch=True,
        milestones=[50, 90, 120],  # 在第90和120个epoch降低学习率
        gamma=0.1)
]
