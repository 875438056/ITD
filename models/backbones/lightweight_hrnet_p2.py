...
from mmengine.model import BaseModel, base_module
...
class Stem(nn.Module):
    def __init__(self,
        ...
        # This first convolution performs 2x downsampling
        self.conv1 = ConvModule(
        ...
        self.branch1 = nn.Sequential(
            ConvModule(
                ...
                branch_channels,
                kernel_size=3,
                # MODIFIED: stride changed from 2 to 1 to prevent downsampling
                stride=1,
                padding=1,
...
@MODELS.register_module(name='lightweight_hrnet_p2')  # Renamed for clarity
class LiteHRNet(BaseModel):
    ...
    def forward(self, x):
        ...
        # Return only the highest resolution feature map in a list,
        # as expected by heads like CenterNetHead
        return x
